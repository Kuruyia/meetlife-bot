                            ...
                            stuff.meetingMan.getMeetingData(meetingId)
                                .then(result => {
                                    ...
                                    if (destroyedCount > 0) {
                                        ...
                                        stuff.sendUtils.notifyUsers(stuff.message.author.id, stuff.client, joinedUsers.users, 'A Meeting you have joined has been removed.', meetingId, meetingData.dataValues);
                                    } else {
