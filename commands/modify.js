    ...
    modifyName(stuff, id, name, ownerOverriden) {
        stuff.meetingMan.modifyMeetingName(id, name)
            .then(function(response) {
                ...
                stuff.sendUtils.notifyUsersInMeeting(stuff.message.author.id, stuff.client, 'The name of a meeting you have joined has been modified.', id);
            })
            .catch(function(e) {
    ...
    modifyDate(stuff, id, startDate, endDate, ownerOverriden) {
        stuff.meetingMan.modifyMeetingDate(id, startDate, endDate)
            .then(function(response) {
                ...
                stuff.sendUtils.notifyUsersInMeeting(stuff.message.author.id, stuff.client, 'The date of a meeting you have joined has been modified.', id);
            })
            .catch(function(e) {
    ...
    modifyLocation(stuff, id, actualFeature, ownerOverriden) {
        stuff.meetingMan.modifyMeetingLocation(id, actualFeature)
            .then(function(response) {
                ...
                stuff.sendUtils.notifyUsersInMeeting(stuff.message.author.id, stuff.client, 'The location of a meeting you have joined has been modified.', id);
            })
            .catch(function(e) {
